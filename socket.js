			...
			socket.on('disconnect', () => {
				...
				if (userCount === 0) {
					...
					*/
					...
					const connectSID = cookie.sign(signedCookie, process.env.COOKIE_SECRET); //내 세션에 저장된 값에 서명된 쿠키값을 붙인다lm41sgKRSNXqSDbwmmmDhyiJenGzaiMT.vmEkXSVKF0myTOnQNV0BKrNa+Nftn2sJ7gO0KngoXuY
